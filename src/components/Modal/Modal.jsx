        ...
        <div className={styles.cardOverlay}>
          <div className={styles.cardGeneral}>
            ...
            <article className={styles.cardArticle}>
              <p className={styles.cardText}>{`Brand: ${props.data.brand}`}</p>
              <p className={styles.cardText}>{`Price: ${props.data.price}`}</p>
              <p className={styles.cardText}>{`Rating: ${props.data.rating}`}</p>
              <p className={styles.cardText}>{props.data.description}</p>
            </article>
